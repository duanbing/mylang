...
#line 40 "string.y"
  ...
  case 3:
#line 44 "string.y"
    { yyval.tnode = newNode(STMT_LIST,yyvsp[-1].tnode,yyvsp[0].tnode,NULL); ;}
    break;
...
#line 48 "string.y"
  ...
  case 6:
#line 49 "string.y"
    { yyval.tnode=newNode(EXPR_STMT,yyvsp[-1].tnode,NULL,NULL);;}
    break;

  case 7:
#line 50 "string.y"
    {  yyval.tnode=newNode(PRINT_STMT,yyvsp[-1].tnode,NULL,NULL);;}
    break;

  case 8:
#line 51 "string.y"
    {  yyval.tnode=newNode(INPUT_STMT,NULL,NULL,NULL);yyval.tnode->symbol=yyvsp[-1].symbol;;}
    break;
...
#line 101 "string.y"
    {
	    ...
	    if (yyval.symbol ==NULL) {
	    	yyval.symbol=newSymDesc(yyvsp[0].str,STR_VAR,NULL,lineno);
